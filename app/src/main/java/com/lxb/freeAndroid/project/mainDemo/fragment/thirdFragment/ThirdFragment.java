package com.lxb.freeAndroid.project.mainDemo.fragment.thirdFragment;
...
public class ThirdFragment extends BaseFragment<ThirdPresenter> implements ThirdContract.CaeView {
    ...
    protected void initViewData(View view, Bundle savedInstanceState) {
        //向首页传参示例
        findViewById(R.id.tv_order).setOnClickListener(v->{
            Bundle bundleParams = new Bundle();
            bundleParams.putString("ThirdFragment","ThirdFragment");
            sendParamsToActivity(bundleParams);
        });
    }
